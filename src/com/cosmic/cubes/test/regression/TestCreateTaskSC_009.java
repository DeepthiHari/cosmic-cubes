...
import com.cosmic.cubes.utils.projectsspec.CreateDriver;
	...
	public class TestCreateTaskSC_009 
	{
		...
		public void testCreateTaskTC_015()
		{
			...
			HandleDropDown.selectDDLByVisiableText(customerddl, "New Customer");
			addNewTask.getCustomerNameTextbox().sendKeys("deepthi");
